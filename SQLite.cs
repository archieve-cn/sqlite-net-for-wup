...
//			public int pk { get; set; }
	...
	public class TableMapping
	{
        ...
        //@Liushk: 加入枚举类型的判断
        public Column EC { get; private set; }
		...
		public class Column
		{
            ...
            //@Liushk: 加入枚举类型判断
            public bool IsEC { get; private set; }
			...
			{
                if (IsEC)
                    return _prop.GetValue(obj, null).ToString();
	...
	public static class Orm
	{
        ...
        public static bool IsEC(MemberInfo p)
        {
            var attrs = p.GetCustomAttributes(typeof(EnumTypeAttribute), true);
	...
	public partial class SQLiteCommand
	{
		...
		object ReadCol (Sqlite3Statement stmt, int index, SQLite3.ColType type, Type clrType)
		{
			if (type == SQLite3.ColType.Null) {
                ...
                else if (clrType == typeof(Enum))
                {
                    return SQLite3.ColumnEnum(stmt, index);
                }
                else if (clrType == typeof(TimeSpan))
                {
	...
	public static class SQLite3
	{
        ...
        [DllImport("sqlite3", EntryPoint = "sqlite3_column_text", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr ColumnEnum(IntPtr stmt, int index);
